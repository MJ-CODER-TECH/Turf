  ...
  return (
    <div className="relative w-full min-h-screen">
      <img
        ...
        alt="turf" className="fixed w-full h-full object-cover"
      />
        ...
        <div className="w-full max-w-[420px] p-8 rounded-2xl dark:bg-[#0d1f3c]/80 bg-white/90 backdrop-blur-md dark:border-[#1a3a5c] border-white/30 border shadow-[0_0_40px_rgba(0,0,0,0.2)]">
          ...
          {[
            ...
            <div key={field.label} className="mb-3">
              <label className="text-[10px] font-bold dark:text-slate-400 text-slate-500 uppercase tracking-wider block mb-1">{field.label}</label>
